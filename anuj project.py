def search_details_staff(trans_ch):
        ...
        a=input("Enter name:")
        while s:
            name,adhaar,city,state,contact,dob,doj,qual,post,shift=tuple(s.split(','))
            if name==a:
                print(s)
            break
            s=f.readline()
...
def search_details_client(trans_ch):
        ...
        a=input("Enter name:")
        while s:
            name,adhaar,address,city,state,contact,dob,trans_from,trans_to,booking_date=tuple(s.split(','))
            if name==a:
                print(s)
            break
            s=f.readline()
...
def write_details_staff(trans_ch):
    ...
    contact=int(input("ENTER YOUR CONTACT NUMBER: "))
        # Split the line into name, adhaar, address, city, state, contact, dob, trans_from, trans_to and booking_date
        name,adhaar,address,city,state,contact,dob,trans_from,trans_to,booking_date=tuple(s.split(','))
        
        # Check if the name matches the user's input
        if name==a:
            # Print the line
            print(s)
        break
    ...
    if trans_ch == 1:
        ...
        # Print "Not found" if the name is not found
        print("Not found")
    # Close the file
    f.close()
...
def update_details(trans_ch, ch):
    address=str(input("ENTER YOUR PERMANENT ADDRESS: "))
    city=str(input("ENTER NAME OF YOUR CITY: "))
    state=str(input("ENTER NAME OF YOUR STATE: "))
    contact=int(input("ENTER YOUR CONTACT NUMBER: "))
...
def update_details_client(trans_ch):
    address=str(input("ENTER YOUR PERMANENT ADDRESS : "))
    city=str(input("ENTER NAME OF YOUR CITY : "))
    state=str(input("ENTER NAME OF YOUR STATE : "))
    contact=int(input("ENTER YOUR CONTACT NUMBER : "))
                ...
                while(True):
                    ...
                    if air_user==1:
                        ...
                        while(True):
                            ...
                            elif air_user_staff == 2:
                                update_details(trans_ch, air_user)
                            else:
                                break
                    elif air_user==2:
                        while(True):
                    ...
                    if water_user==1:
                        ...
                        while(True):
                            ...
                            if water_user_staff == 1:
                                append_details_staff(trans_ch)
                            elif water_user_staff == 2:
                                update_details(trans_ch, water_user)
                            else:
                                break
                    elif water_user==2:
                        while(True):
